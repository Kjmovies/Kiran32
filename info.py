...
API_ID = int(environ.get('API_ID', '7734391023'))
...
URL = "https://kjmovies.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kjmovies.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kjmovies.onrender.com/".format(FQDN)
else:
    URL = "https://kjmovies.onrender.com/".format(FQDN)
